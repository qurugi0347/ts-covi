...
- [ ] 함수 검색/선택과 조건·반복·예외 중첩 블록
- [ ] 내부 함수 참조 펼치기 및 재귀 경계
- [ ] 인자·주석·원문 패널과 소스 위치 표시, M4의 인자 설명 화면 검증
- [ ] 오류/partial/크기 제한/텍스트 안전 렌더링
- [ ] 키보드·포커스·aria·좁은 화면 점검
- [ ] standalone HTML 및 JSON 기반 전체 탐색 E2E
